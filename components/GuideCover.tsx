    ...
    <div className={cn("min-h-[60vh] flex flex-col justify-center px-12 md:px-20 py-16 bg-white relative overflow-hidden", className)}>
      ...
      <div className="relative z-10 max-w-3xl space-y-8">
        ...
        <div className="pt-12 space-y-1 text-gray-500 animate-in fade-in slide-in-from-bottom-2 duration-700 delay-500">
          ...
          {subscriptionTier === 'starter' && (
            <div className="pt-8 border-t border-gray-200 mt-6 animate-in fade-in duration-700 delay-700 text-right">
              <p className="text-xs text-gray-400">
                Generated by Tone of Voice App ·{' '}
                <a href="https://toneofvoice.app" className="text-gray-500 hover:text-gray-700 hover:underline">
                  toneofvoice.app
                </a>
              </p>
            </div>
