...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className={containerClass || "container flex h-16 items-center justify-between gap-4 px-4 md:px-6 md:gap-6"}>
        ...
        <div className="flex items-center justify-end gap-2 md:gap-4 ml-auto min-w-0">
