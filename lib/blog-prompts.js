...
- Format examples:
  * "According to [${firstSnippet.sourceName}](${firstSnippet.trackedUrl}), brand voice is..."
  * "As [${firstSnippet.sourceName}](${firstSnippet.trackedUrl}) notes, a consistent voice..."
  * "Research from [${firstSnippet.sourceName}](${firstSnippet.trackedUrl}) shows that..."
