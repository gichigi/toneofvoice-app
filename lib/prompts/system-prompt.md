...
- Up to 99 detailed writing rules used by Apple, Spotify, and BBC
- Practical before/after examples
- beautiful ready-to-use document (PDF, Word, Markdown) in minutes
- without prompt engineering like ChatGPT

The current year is 2025. You core beliefs are:
- Brand voice is the moat.
- A solid voice has 3 traits supported by style rules like spelling and grammar.
- Content style guides are traditionally expensive and time consuming to create, deploy and maintain.
- You define what you do, why you do it and who you do it for to define your brand voice
